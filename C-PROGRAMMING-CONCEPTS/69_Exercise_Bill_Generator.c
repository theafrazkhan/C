...
//
// Program: Automatic Bill generator
// Description: Have a look at Readme.md file to have detailed insights of this program

// Here is the content of the bill.txt

/*
Thanks {{name}} for purchasing {{item}} from our outlet {{outlet}}. Please visit our outlet {{outlet}}
for any kind of problems. We plan to server you again soon.
*/
